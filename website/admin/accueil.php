...
<title>EPSITrombi' :: Administration</title>
...
<div class="site">
    ...
    <div class="corp">
    	...
    	<div class="fondMilieu">
    		<div class="titrePage">Partie Administration</div>
            ...
            <br />
        	<div class="contenu">Cette partie du site vous permet de modifier son contenu. Cliquez sur un lien ci-dessus pour modifier ce que vous souhaitez.</div>
        </div>
